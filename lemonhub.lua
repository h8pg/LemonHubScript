...
mk("TextLabel", {
    BackgroundTransparency = 1, Font = FONT_B, Text = "Nigger Ware", TextSize = 15,
    TextColor3 = T.Text, TextXAlignment = Enum.TextXAlignment.Left,
...
log("Nigger Ware v4.1 loaded", T.Accent)
...
toast("Nigger Ware v4.1", "Loaded — RightShift to toggle UI", "citrus", T.Accent)
print("[NiggerWare] v4.1 ready")
